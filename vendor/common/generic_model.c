...
#include "vendor/mesh/user/sw_config.h"
...
{
	return my_handle_mesh_cmd_sig_g_on_off_get(par, par_len, cb_par);
}
...
int mesh_cmd_sig_g_onoff_set(u8 *par, int par_len, mesh_cb_fun_par_t *cb_par)
{
	...
	return my_handle_mesh_cmd_sig_g_on_off_set(par, par_len, cb_par);
	#endif
	return -1;
}

int mesh_cmd_sig_onoff_set_manual(
			u8 *par, int par_len, u8 model_idx)
{
	return 0;
}
...
#endif
#if MD_LEVEL_EN
	return my_handle_mesh_cmd_sig_g_level_set(par, par_len, cb_par);
#else
	return -1;
#endif
}
...
int mesh_cmd_sig_cfg_appkey_set_user_handle(u8 *par, int par_len, mesh_cb_fun_par_t *cb_par)
{
	...
	sw_setup_enable_send_config_delay(true, true);
...
#if MD_POWER_ONOFF_EN
	CMD_NO_STR(G_ON_POWER_UP_GET, 0, SIG_MD_G_POWER_ONOFF_C, SIG_MD_G_POWER_ONOFF_S, user_cmd_sig_g_on_powerup_get, STATUS_NONE),
	CMD_NO_STR(G_ON_POWER_UP_SET, 0, SIG_MD_G_POWER_ONOFF_C, SIG_MD_G_POWER_ONOFF_SETUP_S, user_cmd_sig_g_on_powerup_set, STATUS_NONE),
	CMD_NO_STR(G_ON_POWER_UP_SET_NOACK, 0, SIG_MD_G_POWER_ONOFF_C, SIG_MD_G_POWER_ONOFF_SETUP_S, user_cmd_sig_g_on_powerup_set, STATUS_NONE),
#endif
