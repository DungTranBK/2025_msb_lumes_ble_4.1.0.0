...
#define DEEP_RETENTION_POWER_ON_TIME          0 //5000
#define INIT_USER_DELAY_MS                    0 //5000

#define NOTIFY_COLOR_PINK_ENABLE              1
...
#define EN_SWITCH_CONFIG_DIMMING              1
#define DIMMER_EN_BINDING                     1
#define INTER_PROVISION_EN                    0

#define TIMESTAMP_CACULATOR_EN                1

#define REDUCE_POWER_WHEN_CONTROL_RL_EN       0
#define MAP_INPUT_OUTPUT_ENABLE               1

// Auto bind appkey periodically
#define BIND_APPKEY_PERIODIC                  1

#if PCBA_8258_SEL == PCBA_8258_LUMI_V1_0
#define ZERO_CROSSING_ENABLE                  0
#define CACULATOR_FREQ_EN                     0
#define DETECT_RELAY_TYPE_EN                  0
#else
#define ZERO_CROSSING_ENABLE                  1
#define CACULATOR_FREQ_EN                     1
#define DETECT_RELAY_TYPE_EN                  1
#endif

#define MODIFY_SRC_CONTROL_EN                 1
